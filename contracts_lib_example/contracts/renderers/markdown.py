...
from contracts.core.claim_graph import ClaimGraphBundle, FinalProjection
from contracts.core.questionnaire import QuestionnaireResponseSet
...
def render_final_projection_markdown(projection: FinalProjection, bundle: ClaimGraphBundle | None = None) -> str:
    """
    Customer-facing prose from a validated FinalProjection. Optional bundle adds claim ID footnotes.
    """
