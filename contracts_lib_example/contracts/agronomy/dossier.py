...
environments: list[str] = Field(default_factory=list, description="open field / greenhouse / trial station")
management_modes: list[str] = Field(default_factory=list, description="conventional / organic / biological-heavy")
