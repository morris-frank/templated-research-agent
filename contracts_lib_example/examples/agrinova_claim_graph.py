...
from contracts.core.claim_graph import (
    Claim,
    ClaimDependencyLink,
    ClaimEvidenceLink,
    ClaimGraphBundle,
...
from contracts.renderers.markdown import render_final_projection_markdown


def agrinova_bundle() -> ClaimGraphBundle:
